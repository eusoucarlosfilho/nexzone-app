...
export async function salvarCheckoutConfig(productId: string, config: any, bump?: { bump_product_id: string | null; bump_valor: number | null }) {
  ...
  const upd: any = { checkout_config: clean };
  if (bump) {
