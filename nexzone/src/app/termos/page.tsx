...
export const metadata = { title: 'Termos de Uso — NexZone' };
    ...
    <>
      ...
      <div className="page" style={{ maxWidth: 760 }}>
        ...
        <div style={{ color: 'var(--sub)', fontSize: 15, lineHeight: 1.75 }}>
          ...
          <p>Ao acessar e utilizar o NexZone (“Plataforma”), você concorda com estes Termos de Uso. Caso não concorde, não utilize a Plataforma.</p>

          <h2 style={h2}>2. O que é o NexZone</h2>
          <p>O NexZone é um marketplace que conecta criadores (“Vendedores”) e compradores (“Compradores”) para a comercialização de produtos digitais de entrega imediata. A Plataforma atua como intermediadora, disponibilizando a vitrine, o processamento de pagamento e a entrega; não é a autora dos produtos anunciados.</p>
          ...
          <p>O Vendedor é o único responsável pelo conteúdo, pela legalidade, pela titularidade e pela entrega do produto que anuncia. Ao publicar, o Vendedor declara possuir todos os direitos necessários e que o produto não viola leis ou direitos de terceiros. Produtos passam por aprovação antes de ficarem ativos, o que não transfere ao NexZone a responsabilidade pelo conteúdo.</p>
          ...
          <p>A marca, o layout e o software do NexZone pertencem à Plataforma. O conteúdo dos produtos pertence aos respectivos Vendedores.</p>

          <h2 style={h2}>10. Limitação de responsabilidade</h2>
          <p>O NexZone atua como intermediador e não se responsabiliza pela qualidade, veracidade ou adequação dos produtos anunciados pelos Vendedores, sem prejuízo das obrigações legais aplicáveis ao intermediador.</p>
